...
import net.azalealibrary.core.command.GotoCommand;
import net.azalealibrary.core.example.items.InstantKillItem;
import net.azalealibrary.core.example.teams.BlueTeam;
import net.azalealibrary.core.example.teams.RedTeam;
import net.azalealibrary.core.example.winconditions.NoBluePlayers;
import net.azalealibrary.core.example.winconditions.NoRedPlayers;
import net.azalealibrary.core.foundation.configuration.property.CollectionProperty;
...
import net.azalealibrary.core.foundation.registry.RegistryEvent;
