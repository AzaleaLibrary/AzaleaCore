package net.azalealibrary.azaleacore.example;
...
import net.azalealibrary.azaleacore.command.GotoCommand;
import net.azalealibrary.azaleacore.example.items.InstantKillItem;
import net.azalealibrary.azaleacore.example.teams.BlueTeam;
import net.azalealibrary.azaleacore.example.teams.RedTeam;
import net.azalealibrary.azaleacore.example.winconditions.NoBluePlayers;
import net.azalealibrary.azaleacore.example.winconditions.NoRedPlayers;
import net.azalealibrary.azaleacore.foundation.configuration.property.CollectionProperty;
import net.azalealibrary.azaleacore.foundation.configuration.property.Property;
import net.azalealibrary.azaleacore.foundation.configuration.property.PropertyType;
import net.azalealibrary.azaleacore.foundation.registry.RegistryEvent;
import net.azalealibrary.azaleacore.minigame.MinigameIdentifier;
